...
class Ui_main(object):
    ...
    def retranslateUi(self, main):
        ...
        self.pushButton_refresh.setText(_translate("main", "Update"))
        ...
        self.comboBox_microsteps.setItemText(0, _translate("main", "16"))
        self.comboBox_microsteps.setItemText(1, _translate("main", "32"))
        self.comboBox_microsteps.setItemText(2, _translate("main", "64"))
        self.comboBox_microsteps.setItemText(3, _translate("main", "8"))
        self.label_9.setText(_translate("main", "Calibrationfactor = Steps needed for each µL when microstepping=1"))
        self.label_5.setText(_translate("main", "Calibrationfactor for BD 3 mL Syringe"))
        self.label_6.setText(_translate("main", "Calibrationfactor for BD 5 mL Syringe"))
        self.label_7.setText(_translate("main", "Calibrationfactor for BD 10 mL Syringe"))
        self.label_8.setText(_translate("main", "Calibrationfactor for BD 15 mL Syringe"))
